        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php
					$i = 1;
						$qry = $conn->query("SELECT *,concat(first_name,' ',last_name) as name from `users` where id != '1' and id != '{$_settings->userdata('id')}' and `type` != 'admin' order by concat(first_name,' ',last_name) asc ");
