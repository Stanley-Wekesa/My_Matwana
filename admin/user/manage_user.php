            ...
            <option value="3" <?php echo isset($gender) && $gender == 3 ? 'selected' : '' ?>>Others</option>
				...
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select">
						<option value="manager" <?php echo isset($meta['type']) && $meta['type'] == 'manager' ? 'selected' : '' ?>>Manager</option>
						<option value="clerk" <?php echo isset($meta['type']) && $meta['type'] == 'clerk' ? 'selected' : '' ?>>Clerk</option>
					</select>
				</div>
				<div class="form-group col-6">
