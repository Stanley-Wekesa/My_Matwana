...
if(isset($_GET['account_id']) && $_GET['account_id'] > 0){
    $qry = $conn->query("SELECT * from `accounts` where id = '{$_GET['account_id']}' ");
    if($qry->num_rows > 0){
...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($account_id) ? "Update ": "Create New " ?> Accounts</h3>
	</div>
	<div class="card-body">
      ...
      <div class="form-group">
				<label for="name" class="control-label">Initial Investment</label>
                <input name="initial_investment" id="initial_investment" type="text" class="form-control rounded-0" value="<?php echo isset($initial_investment) ? $initial_investment : ''; ?>" required>
			</div>
      <div class="form-group">
				<label for="name" class="control-label">Vehicle Number</label>
